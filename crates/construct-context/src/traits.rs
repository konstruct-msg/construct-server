...
impl DatabaseProvider for crate::AppContext {
    fn pool(&self) -> &Arc<DbPool> {
        &self.db_pool
    }
}
...
impl FederationProvider for crate::AppContext {
    fn server_signer(&self) -> Option<&Arc<ServerSigner>> {
...
impl ConfigProvider for crate::AppContext {
    fn config(&self) -> &Arc<Config> {
        &self.config
    }
...
impl AppContextProvider for crate::AppContext {}
