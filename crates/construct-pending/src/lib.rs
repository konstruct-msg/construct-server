...
//
// PROBLEM: Network failure after mailbox write but before client receives response
...
//   - Server stores PENDING state → Writes to the Redis mailbox → Returns success
