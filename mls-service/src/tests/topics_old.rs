...
async fn test_create_topic_non_admin() {
    ...
    // Create another device that's not an admin
    ...
    let metadata = create_metadata(&other_device_id);
    let request = Request::from_parts(metadata, http::Extensions::new(), req);
...
async fn test_create_topic_empty_name() {
    ...
    let metadata = create_metadata(&device_id);
    let request = Request::from_parts(metadata, http::Extensions::new(), req);
...
async fn test_list_topics_success() {
    ...
    let metadata = create_metadata(&device_id);
    let request = Request::from_parts(metadata, http::Extensions::new(), list_req);
...
async fn test_archive_topic_success() {
    ...
    let metadata = create_metadata(&device_id);
    let request = Request::from_parts(metadata, http::Extensions::new(), create_req);
    ...
    let metadata = create_metadata(&device_id);
    let request = Request::from_parts(metadata, http::Extensions::new(), archive_req);
...
async fn test_revoke_invite_link_success() {
    ...
    let metadata = create_metadata(&device_id);
    let request = Request::from_parts(metadata, http::Extensions::new(), revoke_req);
...
async fn test_resolve_invite_link_valid() {
    ...
    let request = Request::from_parts(http::MetadataMap::new(), http::Extensions::new(), resolve_req);
