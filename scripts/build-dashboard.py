...
panel(R2b, "Устройства без одноразовых предключей",
      ...
      desc="Устройство с нулём OTPK не ломается заметно: собеседник получает "
           ...
           "надо на клиент, не на сервер. В devices нет отметки последней "
           "активности, поэтому знаменатель — все is_active устройства когда-либо: "
           "76 на 2026-08-13 это в основном регистрации марта-апреля (35 из 35 и "
           "26 из 29), тогда как июнь 3 из 21. Наклон честнее абсолютного числа.")
